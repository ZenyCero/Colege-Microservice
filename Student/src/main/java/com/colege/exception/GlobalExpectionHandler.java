...
@Component
public class GlobalExpectionHandler extends AbstractErrorWebExceptionHandler {
    /**
     ...
     * @since 2.4.0
     */
    public GlobalExpectionHandler(ErrorAttributes errorAttributes, WebProperties.Resources resources, ApplicationContext applicationContext, ServerCodecConfigurer codecConfigurer) {
